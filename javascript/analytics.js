...
(function(window, document) {
    ...
    const Analytics = {
         ...
         * Sanitizes the path to prevent injection attacks
         */
        getCleanPage: function() {
            ...
            // Sanitize pathname - remove dangerous characters
            ...
            // Sanitize hash - only allow valid characters
            if (hash) {
            ...
            // Limit total length to 255 characters (database field size)
            const fullPath = pathname + hash;
            if (fullPath.length > 255) {
                return fullPath.substring(0, 255);
            }
